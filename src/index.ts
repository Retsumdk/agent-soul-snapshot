#!/usr/bin/env bun
/**
 * agent-soul-snapshot - Captures behavioral identity and belief state for agent migration
 * Built by Retsumdk
 */
...
program.name("agent-soul-snapshot").description("Captures behavioral identity and belief state for agent migration").version("1.0.0")
